...
Il report è strutturato in cinque sezioni principali. La prima sezione presenta un'analisi esplorativa dei sensori hardware utilizzati e delle loro specifiche tecniche. La seconda sezione esplora la configurazione sperimentale adottata per l'acquisizione consistente dei dati; in essa verranno esposte le metodologie di calibrazione stereo del sistema e fornita una descrizione teorica dell'indice protagonista dell'analisi, l'NDVI. A seguire, le sezioni tre e quattro contengono rispettivamente l'analisi quantitativa, focalizzata sulle metriche scelte per la valutazione dell'errore e della correlazione tra i sensori (MAE, RMSE, Pearson Coefficient), e l'analisi qualitativa basata sul confronto visivo delle mappe generate. La quinta e ultima sezione discute la fattibilità della soluzione proposta, analizzando le variabili che maggiormente influenzano il sistema e delineando le conclusioni e le direzioni future per l'ottimizzazione dell'intera pipeline di elaborazione.
